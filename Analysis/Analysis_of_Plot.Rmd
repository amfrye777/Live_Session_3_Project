...
After plotting the square footage by sales price, we see that:
  ...
  * even though there is a diverse array of data points, the prices seem to be most concentrated in the middle of the graph, the log of square footage falling between 8-8.5, and the log of sales price lying between 15-16.  We added mean in red) and median (blue) points to illustrate this. 
